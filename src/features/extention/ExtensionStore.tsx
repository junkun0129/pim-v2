...
import type { ExtensionMetadata, ExtensionType } from "../src/types";
import Card from "./ui/Card";
import Button from "./ui/Button";
import Badge from "./ui/Badge";
import { ICONS } from "../src/constants";
import { MOCK_EXTENSIONS } from "../src/mockData";
          ...
          return (
            <Card
              ...
              className={`flex flex-col h-full transition-all duration-300 ${
                isActive
                  ? "border-blue-500 shadow-md ring-1 ring-blue-500 dark:border-blue-500"
                  : ""
              }`}
            >
