...
import type { User, Role, Permission } from "../src/types";
                ...
                >
                  ...
                  <td className="px-6 py-4">
                    <select
                      value={user.roleId}
                      onChange={(e) =>
                        onUpdateUserRole(user.id, e.target.value)
                      }
            ...
            <div className="flex gap-2 pt-4 border-t border-slate-100 dark:border-zinc-800 mt-auto">
              ...
              {role.id !== "role_admin" && (
                <Button
                  size="sm"
                  variant="ghost"
                  onClick={() => handleDeleteRoleConfirm(role.id)}
        ...
        <div className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <Input
              ...
              onChange={(e) =>
                setTempRoleData((prev) => ({ ...prev, name: e.target.value }))
              }
          ...
          <div>
            ...
            <div className="space-y-4">
              {PERMISSION_GROUPS.map((group) => (
                <div
                  key={group.label}
                  className="bg-slate-50 dark:bg-zinc-800/50 rounded-lg border border-slate-100 dark:border-zinc-800 overflow-hidden"
                >
                      ...
                      return (
                        <label
                          ...
                          className={`flex items-center gap-3 p-2 rounded-md cursor-pointer transition-all ${
                            isEnabled
                              ? "bg-white dark:bg-zinc-700 shadow-sm ring-1 ring-blue-500/20"
                        ...
                        >
                          ...
                          <input
                            ...
                            onChange={() =>
                              !isLocked &&
                              toggleTempPermission(perm.key as Permission)
                            }
                          />
                          <span
          ...
          <div className="flex justify-end gap-2 pt-4 border-t dark:border-zinc-800">
            ...
            <Button onClick={handleSaveRole} disabled={!tempRoleData.name}>
              保存
            </Button>
          </div>
        </div>
